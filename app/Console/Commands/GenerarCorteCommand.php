...
class GenerarCorteCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:cortes';
     ...
     * @var string
     */
    protected $description = 'Genera cortes automaticos a los deudores expirados';
    ...
    public function handle(): void
    {
        ...
        foreach ($responseBody as $res) {
            if ($res['duedebt'] > 0) {
                // Si el usuario tiene deuda mayor a cero, se agrega al arreglo $userDebts
                $userDebts[] = $res['code'];
            }
        }
